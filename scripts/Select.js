...
class Select extends BaseComponent {
  ...
  updateUI() {
    ...
    const newSelectedOptionElement = selectedOptionElement.textContent.trim();

    const updateOriginalControl = () => {
      this.originalControlElement.value = newSelectedOptionElement
    }

    const updateButton = () => {
      this.buttonElement.textContent = newSelectedOptionElement
  ...
  selectCurrentOption() {
    this.state.selectedOptionElement = this.optionElemens[this.state.currentOptionIndex]
  }
